    ...
    public class ProdutoCRUD
    {
        ...
        public void Create(ProdutoDTO produtoDTO)
        {
            using (MySqlConnection conn = new MySqlConnection(connectionString))
            {
                ...
                string queryProduto = "INSERT INTO Produto (nome_produto, descricao_produto, categoria_produto, tamanho_produto, condicao_produto, preco_produto, imagem_produto, estoque_produto) VALUES (@nomeproduto, @descricaoproduto, @categoriaproduto, @tamanhoproduto, @condicaoproduto, @precoproduto, @imagemproduto, @estoqueproduto)";
        ...
        public void Update(ProdutoDTO produtoDTO)
        {
            using (MySqlConnection conn = new MySqlConnection(connectionString))
            {
                ...
                string query = "UPDATE Produto SET nome_produto = @nomeproduto, descricao_produto = @descricaoproduto, categoria_produto = @categoriaproduto, tamanho_produto = @tamanhoproduto, condicao_produto = @condicaoproduto, preco_produto = @precoproduto, imagem_produto = @imagemproduto, estoque_produto = @estoqueproduto WHERE id_produto = @idproduto";
                MySqlCommand cmd = new MySqlCommand(query, conn);
